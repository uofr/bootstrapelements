...
define(['jquery', 'theme_boost/popover','mod_bootstrapelements/iconpicker'], function($,unused,iconpicker) {
    return {
        init: function () {
            require(['mod_bootstrapelements/iconpicker','theme_boost/popover'], function() {
